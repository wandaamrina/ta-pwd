...
<head>
  ...
  <title>Dashboard Anisah Studio</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>AnisahStudio</span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="hutang.php">
              <i class="fa fa-folder"></i> <span>DATA HUTANG</span>
            </a>
          </li>

          <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>INFO SALDO</span>
            </a>
          </li>

         <li>
            <a href="user.php">
              <i class="fa fa-building"></i> <span>PENGGUNA</span>
            </a>
          </li>
