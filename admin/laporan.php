...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 align="center">LAPORAN PEMASUKAN DAN PENGELUARAN TOKO</h1>
  </section>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari']) && isset($_GET['kategori'])){
              ...
              <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp CETAK LAPORAN</a>
