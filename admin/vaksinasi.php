        ...
        <div class="box box-info">
          ...
          <div class="box-header">
            <div class="btn-group pull-left">          
              ...
              <a href="mahasiswa_json.php" class="btn btn-danger btn-sm pull-right">PDF</a>
            </div>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <th width="10%" class="text-center">TANGGAL VAKSIN</th>
                    <th width="10%" class="text-center">NAMA MAHASISWA</th>
                    <th width="10%" class="text-center">JENIS VAKSIN</th>
                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td class="text-center"><?php echo $d['dosis']; ?></td>
                      <td>
                        <center>     
